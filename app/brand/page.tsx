  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-black text-white flex items-center justify-center">
        <div className="text-emerald-500 font-medium text-sm">Loading Brand Portal...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-6 space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-zinc-950 border border-zinc-800 p-6 rounded-2xl">
          <div>
            <h1 className="text-xl font-bold">Welcome, {user?.user_metadata?.full_name || 'Brand Partner'} 👋</h1>
            <p className="text-xs text-zinc-400 mt-1">Create campaigns, discover creators, and manage sponsorship budgets.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-zinc-950 border border-zinc-800 p-5 rounded-xl">
            <span className="text-xs text-zinc-400 font-medium">Total Spend</span>
          ...
          <div className="bg-zinc-950 border border-zinc-800 p-5 rounded-xl">
            ...
            <span className="text-[10px] text-zinc-500">Running campaigns</span>
          </div>

          <div className="bg-zinc-950 border border-zinc-800 p-5 rounded-xl">
            <span className="text-xs text-zinc-400 font-medium">Creator Proposals</span>
            <div className="text-2xl font-bold mt-2 text-amber-400">0</div>
            <span className="text-[10px] text-zinc-500">Pending approval</span>
          </div>

          <div className="bg-zinc-950 border border-zinc-800 p-5 rounded-xl">
            <span className="text-xs text-zinc-400 font-medium">Account Status</span>
            <div className="text-sm font-bold mt-2 text-emerald-500">Verified</div>
            <span className="text-[10px] text-zinc-500">Ready to hire</span>
          </div>
        </div>

        {/* Kampanya Listesi */}
        <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6">
          <h2 className="text-sm font-bold mb-4">Your Campaigns</h2>
          
          <div className="border border-dashed border-zinc-800 rounded-xl p-8 text-center">
            <p className="text-xs text-zinc-400">No campaigns launched yet.</p>
            <p className="text-[11px] text-zinc-600 mt-1">Start by creating a campaign to connect with top creators.</p>
          </div>
        </div>
